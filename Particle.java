...
public class Particle {
    public Particle() {
        ...
        File directoryPath = new File("./assets/minecraft/textures/particle");
        ...
        System.out.println("Randomizing particles!");
        for(File fileName : list) {
            if (!fileName.toString().contains(".mcmeta")) {
                fixedList.add(fileName.getName());
                fileName.renameTo(new File("./assets/minecraft/textures/particle/" + i + ".png"));
                i++;
            }
        }
        ...
        for(int counter = 0; counter < size; counter++) {
            File renameBack = new File("./assets/minecraft/textures/particle/" + counter + ".png");
            rand_int = rand.nextInt(upperbound);
            File rename = new File("./assets/minecraft/textures/particle/" + fixedList.get(rand_int));
